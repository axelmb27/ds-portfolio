# Axel — Data Science Portfolio

Physics M.Sc. (ICN-UNAM) moving into data science, with a background in numerical
modeling and cosmic-ray data analysis (HAWC experiment). I like problems where I have to understand the data, not just blindly fit a model.
...
- Rare-event / risk modeling: imbalanced classification and ranking under a budget constraint.
